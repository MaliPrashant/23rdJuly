...
public class Byjus1 {
	...
	public void LoginTest() throws InterruptedException{
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@name=\"name\"]")).sendKeys("Sarthak");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//input[@name=\"email\"]")).sendKeys("SArthak345@gmail.com");
		Thread.sleep(3000);
		...
		String address = driver.findElement(By.xpath("(//p)[1]")).getText();
		if(address.equals("Pune, India")) {
